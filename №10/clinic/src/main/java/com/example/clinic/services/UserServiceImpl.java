...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public void deleteAppointment(User user, Integer appointmentId) {
        clinicDAO.getAppointmentDAO().delete(user, appointmentId);
    }
    ...
    public Collection<Appointment> findAllAppointments(User user) {
        return clinicDAO.getAppointmentDAO().findByUserId(user.getUserId());
    }
