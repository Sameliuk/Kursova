...
public class InMemoryTestData {
    ...
    public static void generateTo(InMemoryDatabase database) {
        ...
        Appointment appointment1 = new Appointment(1, alice.getUserId(), smith.getDoctorId(), LocalDateTime.parse("2024-04-18T10:00:00"));
        Appointment appointment2 = new Appointment(2, bob.getUserId(), johnson.getDoctorId(), LocalDateTime.parse("2024-04-20T14:00:00"));
        Appointment appointment3 = new Appointment(3, charlie.getUserId(), adams.getDoctorId(), LocalDateTime.parse("2024-04-22T11:00:00"));
        Appointment appointment4 = new Appointment(4, diana.getUserId(), white.getDoctorId(), LocalDateTime.parse("2024-04-25T09:00:00"));
        Appointment appointment5 = new Appointment(5, evil.getUserId(), brown.getDoctorId(), LocalDateTime.parse("2024-04-27T15:00:00"));
